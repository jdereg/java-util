...
class MultiKeyMapMapApiTest {
    ...
    void testIsEmpty() {
        ...
        map.put("test", String.class, Integer.class, 1L);
    ...
    void testContainsValue() {
        ...
        map.put("test1", String.class, Integer.class, 1L);
        map.put("test2", String.class, Long.class, 2L);
        map.put(null, Integer.class, String.class, 3L);
    ...
    void testRemove() {
        ...
        map.put("test1", String.class, Integer.class, 1L);
        map.put("test2", String.class, Long.class, 2L);
        map.put("test3", Integer.class, String.class, 3L);
    ...
    void testClear() {
        ...
        map.put("after_clear", Double.class, Boolean.class, 10L);
    ...
    void testValues() {
        ...
        map.put("test1", String.class, Integer.class, 1L);
        map.put("test2", String.class, Long.class, 2L);
        map.put("test1", Integer.class, String.class, 3L); // Duplicate value
        map.put(null, Double.class, Boolean.class, 4L); // Null value
    ...
    void testRemoveWithCollisions() {
        ...
        map.put("value1", String.class, Integer.class, 1L);
        map.put("value2", String.class, Integer.class, 2L);
        map.put("value3", String.class, Integer.class, 3L);
        map.put("value4", String.class, Long.class, 1L);
