...
- List of files modified for this change (including any new files created)
...
- **Ask: "Should I add and commit this change? (Y/N)"** - This covers both adding new files and committing all changes
